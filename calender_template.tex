...
\tikzstyle{day letter headings}=[
    execute before day scope={ \ifdate{day of month=1}{%
      ...
      \foreach \d/\l in {0/Sunday,1/Monday,2/Tuesday,3/Wesnday,%
...
\centering
    ...
    {\includegraphics[width=.9\paperwidth, height=.9\paperheight]{M87_Super-Volcano.jpg}};
\end{tikzpicture}
...
\begin{tikzpicture}[thick]
  \calendar[dates=2015-01-01 to 2015-01-last,
            ...
            if (day of month = 1) [observance=New Years]
            if (day of month = 20) [observance= New Moon $\newmoon$];
\end{tikzpicture}
