...
\centering
    \node (russell) at (0,0)
    {\includegraphics[width=.9\paperwidth, height=.9\paperheight]{Comet_lemon-RGB.jpg}};
\end{tikzpicture}
...
\centering
    ...
    {\includegraphics[width=.9\paperwidth, height=.9\paperheight]{M42-RG.jpg}};
\end{tikzpicture}
...
\centering
    \node[inner sep=1pt] (russell) at (0,0)
    {\includegraphics[width=.9\paperwidth, height=.9\paperheight]{NGC_1763-LRGB.jpg}};
\end{tikzpicture}
...
%             day headings={font=\footnotesize},
%             day letter headings]
%             if (day of month = 21) [observance=Human Rights Day];
% \end{tikzpicture}
% 
% \begin{tikzpicture}[thick]
